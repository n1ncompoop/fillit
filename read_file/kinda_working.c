...
/*   Updated: 2018/03/25 05:32:43 by pnarayan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	map_coords(t_tetris **tetris, int *coords, int tet_id)
{
	int		x;
	int		k;
	int		id;
	...
	//ft_putchar('\n');
	ft_add_piece(tetris, coords);
}

void	extract_tet(t_tetris **tetris, char **arr, int tet_id)
{
	int			x;
	int			i;
	int			j;
	...
	map_coords(tetris, coords, tet_id);
}

void	conv_2d(t_tetris **tetris, char *str, int tet_id)
{
	char	**arr;
	int		i;
	int		j;
...
void	divide_pieces(char *f_str)
{
	...
	while (f_str[i])
	{
		...
		if (i > 0 && f_str[i - 1] == '\n')
		{
			...
			{
				//ft_putstr(piece_str);
				conv_2d(tetris, piece_str, tet_id);
				tet_id++;
				mod = mod + 21;
